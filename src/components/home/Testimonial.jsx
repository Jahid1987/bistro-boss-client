...
const Testimonial = () => {
  ...
  return (
    <section>
      ...
      />
      <div className="w-full md:w-11/12 lg:w-3/4 mx-auto my-4 md:my-6 lg:my-8">
        <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
          {reviews.map((review) => (
            <SwiperSlide key={review._id}>
              <div className="flex gap-3 flex-col  items-center mx-12 my-8 lg:mx-24 lg:my-16">
                <Rating
                  style={{ maxWidth: 100 }}
                  value={review.rating}
                  readOnly
                ...
                <p className="my-3 text-slate-500">{review.details}</p>
